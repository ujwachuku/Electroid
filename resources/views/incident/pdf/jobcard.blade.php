        ...
        <div>
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td class="text-left">{{ $incident->code }}</td>
                    <td class="heading text-right">Fleet Nr:</td>
                    <td class="text-left">{{ $incident->vehicle->fleet_nr }}</td>
                    <td class="heading text-right">Team:</td>
                    <td class="text-left">{{ $incident->team->name  }}</td>
                </tr>
                <tr>
                    <td class="heading text-right">Reg Nr:</td>
                    <td class="text-left">{{ $incident->vehicle->reg_nr }}</td>
                    <td class="heading text-right">Model:</td>
                    <td class="text-left">{{ $incident->vehicle->model->name }}</td>
                    <td class="heading text-right">Chassis Nr:</td>
                    <td class="text-left">{{ $incident->vehicle->vin_nr }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="6" class="text-left">
                        <div class="description border">{!! htmlspecialchars_decode($incident->action) !!}</div>
                    </td>
                </tr>
            </table>
        </div>
