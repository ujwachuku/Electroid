<aside style="min-width: 200px; max-width: 200px; padding-top: 65px" class="bg-imperial-primer border-right vh-100">
    <nav class="list-group list-group-flush">
        ...
        <a href="{{ route('fleet.model.index') }}" class="list-group-item list-group-item-action border-0">Models</a>
        ...
        <a href="{{ route('user.role.index') }}" class="list-group-item list-group-item-action border-0">User Roles</a>
